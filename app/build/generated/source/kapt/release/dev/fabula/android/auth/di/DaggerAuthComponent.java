...
import dev.fabula.android.auth.ui.AuthViewModel_Factory;
...
public final class DaggerAuthComponent implements AuthComponent {
  ...
  private DaggerAuthComponent(SyncApiModule syncApiModuleParam,
  ...
  private void initialize(final SyncApiModule syncApiModuleParam,
    ...
    this.authViewModelProvider = AuthViewModel_Factory.create(provideRetrofitProvider, provideAuthProvider, syncRepositoryProvider);
  }
