...
import dev.fabula.android.report.repo.ReportRepository_Factory;
import dev.fabula.android.report.ui.ReportFragment;
import dev.fabula.android.report.ui.ReportViewModel;
import dev.fabula.android.report.ui.ReportViewModel_Factory;
...
public final class DaggerReportComponent implements ReportComponent {
  ...
  private DaggerReportComponent(SyncApiModule syncApiModuleParam,
  ...
  private Map<Class<? extends ViewModel>, Provider<ViewModel>> getMapOfClassOfAndProviderOfViewModel(
    ...
    return MapBuilder.<Class<? extends ViewModel>, Provider<ViewModel>>newMapBuilder(2).put(ReportViewModel.class, (Provider) reportViewModelProvider).put(SyncViewModule.class, (Provider) syncViewModuleProvider).build();
  }
  ...
  private void initialize(final SyncApiModule syncApiModuleParam,
    ...
    this.reportRepositoryProvider = ReportRepository_Factory.create(providesMeasurementTypeDAOProvider);
    ...
    this.measurementsRepositoryProvider = MeasurementsRepository_Factory.create(providesCreateMeasurementsDAOProvider, providesPlatformDAOProvider2, providesMeasurementTypeDAOProvider);
    ...
    this.canopyRepositoryProvider = CanopyRepository_Factory.create(providesPlatformDAOProvider2, providesCreateMeasurementsDAOProvider);
    this.reportViewModelProvider = ReportViewModel_Factory.create(railwayRepositoryProvider, railwaySectionRepositoryProvider, supportRepositoryProvider, screenMeasurementsRepositoryProvider, reportRepositoryProvider, platformRepositoryProvider, measurementsRepositoryProvider, stationPeregonRepositoryProvider, dimensionsFenceRepositoryProvider, canopyRepositoryProvider);
  ...
  @Override
  public void inject(ReportFragment fragment) {
    injectReportFragment(fragment);
  }

  private ReportFragment injectReportFragment(ReportFragment instance) {
  ...
  public static final class Builder {
     ...
     */
    @Deprecated
    public Builder reportDaoModule(ReportDaoModule reportDaoModule) {
      Preconditions.checkNotNull(reportDaoModule);
      return this;
    }
