...
import dev.fabula.android.module.mtprotocol.util.statemachine.impl.State;
...
public class DescriptorImpl implements Descriptor {
	...
	private final static Logger LOG = Logger.getLogger(dev.fabula.android.module.mtprotocol.util.statemachine.impl.DescriptorImpl.class.getName());
