...
public class EDCOutputMessage implements MtMessage {
	...
	public static final int HEIGHT_DISTANCE_REQUEST = 11;
	public static final int HEIGHT_DISTANCE_REQUEST2 = 10;
	// TODO: insert all valid values
	
	// remoteCtrlData header
	public static final int REMOTE_CTRL_DATA = 0; //unused
	public static final int REMOTE_CTRL_DATA_ = 1; //unused
